      ...
      bulletPoints={[
        {
          ...
          description: "Create complex survey forms without coding.",
        },
        {
          title: "Advanced Data Analysis",
          description: "Export and interpret data using our advanced analytical tools.",
        },
        {
          title: "Offline Capability",
          description: "Collect data in remote locations with ease.",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Gain an official certificate upon course completion.",
        },
        {
          icon: Shield,
          title: "Secure Data",
          description: "Learn industry-standard protocols for data privacy.",
        },
        {
          icon: Zap,
          title: "Efficient Workflows",
          description: "Maximize your team's efficiency in the field.",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          id: "5",
          name: "Nour Ali",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-hat-with-book-garden_1157-37040.jpg",
        },
      ]}
