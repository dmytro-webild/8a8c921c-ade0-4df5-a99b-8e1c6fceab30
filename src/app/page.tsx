...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          icon: CheckCircle,
          title: "Certified Expert",          description: "Gain an official certificate upon course completion."},
        {
          icon: Shield,
          title: "Secure Data",          description: "Learn industry-standard protocols for data privacy."},
        {
          icon: Zap,
          title: "Efficient Workflows",          description: "Maximize your team's efficiency in the field."},
      ]}
